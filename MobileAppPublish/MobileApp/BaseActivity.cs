        ...
        private void HomeNavigationView_NavigationItemSelected(object sender, NavigationView.NavigationItemSelectedEventArgs e)
        {
            ...
            switch (menuItem.ItemId)
            {
                ...
                case Resource.Id.syncCollection:
                    ...
                    break;
                case Resource.Id.exportCollection:
                    intent = new Intent(this, typeof(ExportCollectionActivity));
                    break;
                ...
                case Resource.Id.syncMasterData:
                    ...
                    break;
                case Resource.Id.syncNewSavings:
                    intent = new Intent(this, typeof(DownloadNewSavingsActivity));
                    break;
                ...
                case Resource.Id.savingsLedgerWeb:
                    ...
                    drawerLayout.CloseDrawers();
                    break;
                case Resource.Id.barcodeReader:
                    intent = new Intent(this, typeof(BarcodeAutoReadActivity));
                    break;
