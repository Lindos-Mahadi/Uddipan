...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PMS.Droid.CustomGridViewAdapter, MobileApp", CustomGridViewAdapter.class, __md_methods);
	}
	...
	public CustomGridViewAdapter ()
	{
		...
		if (getClass () == CustomGridViewAdapter.class)
			mono.android.TypeManager.Activate ("PMS.Droid.CustomGridViewAdapter, MobileApp", "", this, new java.lang.Object[] {  });
	}
