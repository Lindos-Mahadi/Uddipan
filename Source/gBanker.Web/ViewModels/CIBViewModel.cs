...
{
    public class CIBViewModel : BaseModel
    {
        ...
        [Display(Name = "বাংলায় In Bangla")]
        [Required(ErrorMessage = "বাংলায় In Bangla is required.")]
        ...
        [Display(Name = "Address Details(Location)")]
        ...
        [Display(Name = "পিতার নাম (Father’s Name)")]
        [Required(ErrorMessage = "বাংলায়")]
        public string FatherNameBN { get; set; }

        [Required(ErrorMessage = "Mother Name ইংরেজিতে  is required.")]
        [Display(Name = "Mother Name")]
        public string MotherName { get; set; }

        [Display(Name = "মাতার নাম (Mother’s Name) বাংলায়")]
        [Required(ErrorMessage = "মাতার নাম (Mother’s Name) বাংলায় is required.")]
