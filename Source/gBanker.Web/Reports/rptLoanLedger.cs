...
namespace gBanker.Web.Reports {
    ...
    public class rptLoanLedger : ReportClass {
        
        public rptLoanLedger() {
        }
        
        public override string ResourceName {
            get {
                return "rptLoanLedger.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.rptLoanLedger.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptLoanLedger : Component, ICachedReport {
        
        public CachedrptLoanLedger() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptLoanLedger rpt = new rptLoanLedger();
            rpt.Site = this.Site;
            return rpt;
        }
