...
namespace gBanker.Web.Reports {
    ...
    public class POMIS_1HQ_SSS : ReportClass {
        
        public POMIS_1HQ_SSS() {
        }
        
        public override string ResourceName {
            get {
                return "POMIS_1HQ_SSS.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.POMIS_1HQ_SSS.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPOMIS_1HQ_SSS : Component, ICachedReport {
        
        public CachedPOMIS_1HQ_SSS() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            POMIS_1HQ_SSS rpt = new POMIS_1HQ_SSS();
            rpt.Site = this.Site;
            return rpt;
        }
