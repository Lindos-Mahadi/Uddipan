...
namespace gBanker.Web.Reports {
    ...
    public class MRA_MIS_03B : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.MRA-MIS-03B.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedMRA_MIS_03B : Component, ICachedReport {
        
        public CachedMRA_MIS_03B() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            MRA_MIS_03B rpt = new MRA_MIS_03B();
            rpt.Site = this.Site;
            return rpt;
        }
