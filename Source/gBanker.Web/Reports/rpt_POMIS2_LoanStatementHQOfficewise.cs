...
namespace gBanker.Web.Reports {
    ...
    public class rpt_POMIS2_LoanStatementHQOfficewise : ReportClass {
        
        public rpt_POMIS2_LoanStatementHQOfficewise() {
        }
        
        public override string ResourceName {
            get {
                return "rpt_POMIS2_LoanStatementHQOfficewise.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.rpt_POMIS2_LoanStatementHQOfficewise.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedrpt_POMIS2_LoanStatementHQOfficewise : Component, ICachedReport {
        
        public Cachedrpt_POMIS2_LoanStatementHQOfficewise() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rpt_POMIS2_LoanStatementHQOfficewise rpt = new rpt_POMIS2_LoanStatementHQOfficewise();
            rpt.Site = this.Site;
            return rpt;
        }
