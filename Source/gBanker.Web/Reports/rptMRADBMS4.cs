...
namespace gBanker.Web.Reports {
    ...
    public class rptMRADBMS4 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.rptMRADBMS4.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptMRADBMS4 : Component, ICachedReport {
        
        public CachedrptMRADBMS4() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptMRADBMS4 rpt = new rptMRADBMS4();
            rpt.Site = this.Site;
            return rpt;
        }
