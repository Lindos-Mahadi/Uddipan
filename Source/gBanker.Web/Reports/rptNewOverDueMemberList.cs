...
namespace gBanker.Web.Reports {
    ...
    public class rptNewOverDueMemberList : ReportClass {
        
        public rptNewOverDueMemberList() {
        }
        
        public override string ResourceName {
            get {
                return "rptNewOverDueMemberList.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.rptNewOverDueMemberList.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptNewOverDueMemberList : Component, ICachedReport {
        
        public CachedrptNewOverDueMemberList() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptNewOverDueMemberList rpt = new rptNewOverDueMemberList();
            rpt.Site = this.Site;
            return rpt;
        }
