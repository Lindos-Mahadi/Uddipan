...
namespace gBanker.Web.Reports {
    ...
    public class rptMRADBMS2 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.rptMRADBMS2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptMRADBMS2 : Component, ICachedReport {
        
        public CachedrptMRADBMS2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptMRADBMS2 rpt = new rptMRADBMS2();
            rpt.Site = this.Site;
            return rpt;
        }
