...
namespace gBanker.Web.Reports {
    ...
    public class MRA_MIS_04B : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "gBanker.Web.Reports.MRA-MIS-04B.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedMRA_MIS_04B : Component, ICachedReport {
        
        public CachedMRA_MIS_04B() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            MRA_MIS_04B rpt = new MRA_MIS_04B();
            rpt.Site = this.Site;
            return rpt;
        }
