...
{
    //class gBankerJCFCollectionSheet
    //{
    //}
    public class gBankerJCFCollectionSheet : DataAccessBase
    {

        public gBankerJCFCollectionSheet()
        {
        ...
        protected override ConnectionStringSettings LoadConnectionStringSetting()
        {
            ...
            var connectionSrings = ConfigurationManager.ConnectionStrings["gBankerJCFReportContext"];
