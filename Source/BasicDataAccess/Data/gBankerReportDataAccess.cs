...
namespace BasicDataAccess.Data
{
    ...
    public class gBankerReportDataAccess : DataAccessBase
    {

        public gBankerReportDataAccess()
        {
        ...
        protected override ConnectionStringSettings LoadConnectionStringSetting()
        {
            ...
            var connectionSrings = ConfigurationManager.ConnectionStrings["gBankerReport"];
