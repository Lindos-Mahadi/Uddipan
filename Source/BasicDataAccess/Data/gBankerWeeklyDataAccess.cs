...
namespace BasicDataAccess.Data
{
    ...
    public class gBankerWeeklyDataAccess : DataAccessBase
    {

        public gBankerWeeklyDataAccess()
        {
        ...
        protected override ConnectionStringSettings LoadConnectionStringSetting()
        {
            ...
            var connectionSrings = ConfigurationManager.ConnectionStrings["gBankerWeeklyDataAccess"];
