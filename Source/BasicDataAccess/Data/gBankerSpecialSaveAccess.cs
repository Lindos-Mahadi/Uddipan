...
{
    public class gBankerSpecialSaveAccess : DataAccessBase
    {

        public gBankerSpecialSaveAccess()
        {
        ...
        protected override ConnectionStringSettings LoadConnectionStringSetting()
        {
            ...
            var connectionSrings = ConfigurationManager.ConnectionStrings["gBankerSpecialSaveContext"];
