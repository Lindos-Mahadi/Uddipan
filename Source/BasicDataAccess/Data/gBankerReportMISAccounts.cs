...
{
    public class gBankerReportMISAccounts : DataAccessBase
    {
        public gBankerReportMISAccounts()
        {

        }
        protected override ConnectionStringSettings LoadConnectionStringSetting()
        {
            var connectionSrings = ConfigurationManager.ConnectionStrings["gBankerReportMISAccounts"];
